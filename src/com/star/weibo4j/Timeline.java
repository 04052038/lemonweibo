...
public class Timeline {
	...
	public StatusWapper getFriendsTimelineSince(Integer baseAPP, Integer feature,
			String sinceId) throws WeiboException {
		return Status.constructWapperStatus(Weibo.client.get(
				WeiboConfig.getValue("baseURL") + "statuses/friends_timeline.json",
				new PostParameter[] {
						new PostParameter("base_app", baseAPP.toString()),
	...
	public Status destroyStatus(String statusId) throws WeiboException {
		return new Status(Weibo.client.post(WeiboConfig.getValue("baseURL")
				+ "statuses/destroy.json", new PostParameter[] {
				new PostParameter("id", statusId) }));
	}
