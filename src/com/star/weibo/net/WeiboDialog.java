...
public class WeiboDialog extends Dialog {
	...
	private void setUpTitle() {
		...
		View titleView = View.inflate(this.getContext(),R.layout.titlebar,null);
		titleView.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FILL_PARENT,
                60));
		TextView name = (TextView) titleView.findViewById(R.id.titlebar_name);
		name.setVisibility(View.VISIBLE);
		name.setText("新浪微博账号登陆");
		mContent.addView(titleView);
    ...
    private void handleRedirectUrl(WebView view, String url) {
    	Log.i(TAG, "handleRedirectUrl url = " + url);
        ...
        if (error == null && error_code == null) {
        	...
        	Log.d(TAG, "handleRedirectUrl: " + error);
