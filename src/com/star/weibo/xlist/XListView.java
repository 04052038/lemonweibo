...
public class XListView extends ListView implements OnScrollListener {
	...
	private void resetFooterHeight() {
		...
		Log.i("xlistview", "resetFooterHeight bottomMargin=" + bottomMargin);
		if (bottomMargin > 0) {
			mScrollBack = SCROLLBACK_FOOTER;
			Log.i("xlistview", "resetFooterHeight startScroll" );
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		default:
			...
			if (getFirstVisiblePosition() == 0 && isPulldown) {
				...
				resetHeaderHeight();
			} else if (getLastVisiblePosition() == mTotalItemCount - 1 && isPullup) {
				isPullup = false;
				// invoke load more.
				if (mEnablePullLoad
						&& mFooterView.getVisiableHeight() > mFooterViewHeight && !mPullLoading) {
					startLoadMore();
				}
				resetFooterHeight();
			}
